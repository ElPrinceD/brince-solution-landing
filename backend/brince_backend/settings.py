"""
Django settings for brince_backend project.
"""
...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,brincesolutions.com,www.brincesolutions.com').split(',')
...
ROOT_URLCONF = 'brince_backend.urls'
...
WSGI_APPLICATION = 'brince_backend.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://localhost:3000",
    "https://brincesolutions.com",
    "https://www.brincesolutions.com",
    "https://elprinced.github.io",
]
...
# Google Places API (for fetching Google Reviews)
